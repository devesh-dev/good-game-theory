...
const test = () => {
  return (
    <div className="grid md:grid-cols-3 bg-blue-600 max-w-full ">
      <div className="grid gap-2 mx-auto p-5 ">
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <h1 className="text-2xl font-bold mb-4 ">Delicious Chocolate Cake</h1>
          ...
          <ol className="list-decimal list-inside mb-6">
            <li className="mb-2">
              Preheat your oven to 350°F (175°C). Grease and flour two 9-inch
              round cake pans.
            </li>
            <li className="mb-2">
